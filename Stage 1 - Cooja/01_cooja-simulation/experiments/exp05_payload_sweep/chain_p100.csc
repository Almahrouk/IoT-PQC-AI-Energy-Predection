...
<simconf version="2022112801">
  <simulation>
    <title>EXP05 chain payload=100</title>
    ...
    <motetype>
      ...
      <description>PQC Stub Node payload=100</description>
      <source>[CONFIG_DIR]/../../code/pqc-stub-node.c</source>
      <commands>$(MAKE) -j$(CPUS) PQC_PAYLOAD=100 PQC_HOP_COUNT=2 PQC_TOPO=chain pqc-stub-node.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiRS232</moteinterface>
...
var fw = new java.io.FileWriter(
  "/home/user/contiki-ng/examples/pqc-iot-sim/experiments/exp05_payload_sweep/results/pqc_raw_chain_p100.log",
  false);
