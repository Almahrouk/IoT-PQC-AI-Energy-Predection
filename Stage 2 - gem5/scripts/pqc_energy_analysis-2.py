...
GEM5_CSV = '/home/user/gem5_results/paper_dataset_fixed.csv'
...
def page_ml_models(df_enc, pdf):
    """Page 6 – ML model comparison (Exp A: run-level KFold)"""
    fig = plt.figure(figsize=(16, 11))
    fig.suptitle("ML Energy Prediction — 5-Fold Cross Validation\n"
                 "Training on 100-run expanded dataset (3,300 rows)", fontsize=13)
